...
export function MaintenancePage() {
	return (
		...
		>
			...
			<div className="pointer-events-none fixed left-0 right-0 h-px" style={{ bottom: "3dvh", background: "linear-gradient(90deg, transparent, var(--primary), transparent)", opacity: 0.25, animation: "scan 10s ease-in-out infinite 5s", zIndex: 0 }} />
			<Particles />
