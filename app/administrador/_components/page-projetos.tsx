...
type TipoCategoria = "Comercial" | "Residencial" | "Saúde";

/**
 * Contrato mínimo que qualquer item editável no ProjectDetail deve cumprir.
 * Projeto e Produto estendem esta interface adicionando campos específicos.
 *
 * Campos obrigatórios: presentes em AMBOS os tipos.
 * Campos opcionais (?): usados apenas num dos modos (isProd true/false).
 */
...
export interface Projeto extends ItemEditavel {
	...
	status: TipoStatus; // mais específico que string
}
