...
import { PageClientes } from "./pages/page-clients";
import { PageAtividade } from "./pages/page-atividade";
import { PageConfig } from "./pages/page-config";
import { PageConteudo } from "./pages/page-conteudo";
import { PageLogs } from "./pages/page-logs";
import { PageUsuarios } from "./pages/page-users";
...
export default function PaginaAdministrador() {
	...
	const [collapsed, setCollapsed] = useState(
		TWEAKS_PADRAO.sidebarStyle === "expanded",
	);
