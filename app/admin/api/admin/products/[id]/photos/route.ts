// app/api/admin/products/[id]/photos/route.ts
...
export async function GET(_req: NextRequest, { params }: RouteParams) {
	try {
		...
		console.error("[/api/admin/products/:id/photos] Erro ao listar:", error);
...
export async function POST(req: NextRequest, { params }: RouteParams) {
	try {
		...
		console.error("[/api/admin/products/:id/photos] Erro ao adicionar:", error);
		return NextResponse.json(
